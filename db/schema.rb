...
ActiveRecord::Schema.define(version: 20170427040418) do
  ...
  add_index "reactions", ["retweeting_user", "original_status"], name: "index_reactions_on_retweeting_user_and_original_status", unique: true
